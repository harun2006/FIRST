  ...
  updateThemeIcon(theme) {
    ...
    if (icon) {
      if (theme === 'dark') {
        ...
        icon.style.color = '#FF9800'; // Golden sun color
      } else {
...
// Smart routing for the Dashboards link (Moved outside the object!)
